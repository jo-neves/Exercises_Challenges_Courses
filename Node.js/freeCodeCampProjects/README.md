...
1. Random Quote Machine App:
    ...
    . [Repository](https://github.com/jo-neves/freeCodeCamp/tree/master/Random_Quote_App)
...
2. Local Weather App:
    ...
    . [Repository](https://github.com/jo-neves/freeCodeCamp/tree/master/Weather_App)

3. *Wikipedia Viewer Search Engine:

    . [CodePen.io](https://codepen.io/shivayl/full/qVVbdO/)
  
    . [Repository](https://github.com/jo-neves/freeCodeCamp/tree/master/Wikipedia_Viewer_App)
...
1. Timestamp Microservice:
    ...
    . [Repository](https://github.com/jo-neves/freeCodeCamp/tree/master/Timestamp_Microservice)

2. Request Header Parser Microservice (WhoAmI):

    . [Glitch.com](https://who-shivayl.glitch.me/)
    
    . [Repository](https://github.com/jo-neves/freeCodeCamp/tree/master/WhoAmI_Microservice)

3. URL Shortener Microservice (XS-URL):

    . [Glitch.com](https://xs-url.glitch.me/)
    
    . [Repository](https://github.com/jo-neves/freeCodeCamp/tree/master/URL_Shortener_Microservice)
    
4. *Image Search Abstraction Layer (FindImages.com):

    . [Glitch.com](https://findimages.glitch.me/)
    
    . [Repository](https://github.com/jo-neves/freeCodeCampProjects/tree/master/Image_Search_Abstraction_Layer)
